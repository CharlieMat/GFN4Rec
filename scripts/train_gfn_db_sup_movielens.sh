...
do
    for ACTOR_LR in 0.0001 # 0.00001 0.000001
    do
        for SEED in 11 # 11 13 17 19 23
        do
            for ALPHA in 0.1 0.5 0.9
            do
                file_key=${AGENT_CLASS}_${POLICY_CLASS}_R${R_SMOOTH}_F${FWD_OFFSET}_Z${Z}_alpha${ALPHA}_actor${ACTOR_LR}_niter${N_ITER}_reg${REG}_ep${INITEP}_bs${BS}_epbs${EP_BS}_seed${SEED}
